...
parser.add_argument(
    "--robust-indices", default="", type=str, help="path to samples whose indices are selected by robust subsampling method."
)
parser.add_argument(
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    normalize = transforms.Normalize(mean=[0.47889522, 0.47227842, 0.43047404], std=[0.24205776, 0.23828046, 0.25874835])
    train_dataset = torchvision.datasets.ImageFolder('./data/cinic-10-imagenet/train', transform = transforms.Compose(
            [
    ...
    val_loader = torch.utils.data.DataLoader(
        datasets.CIFAR10(root='./cifar', train = False, download = True, transform = transforms.Compose(
                [
                    transforms.ToTensor(),
                    val_normalize,
                ]
