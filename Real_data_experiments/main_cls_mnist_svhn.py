...
def main_worker(gpu, ngpus_per_node, args):
    ...
    train_dataset = torchvision.datasets.MNIST('./data', train = True, transform = transforms.Compose(
            [
    ...
    val_transform = transforms.Compose([transforms.ToTensor(), val_normalize])
    val_dataset_1 = datasets.SVHN(root = './data', split = 'train', transform = val_transform)
    val_dataset_2 = datasets.SVHN(root = './data', split = 'test', transform = val_transform)
